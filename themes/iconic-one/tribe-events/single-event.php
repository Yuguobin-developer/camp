...
<div id="ts-inner" class="flex f1 fbreak1 g2">
<div class="ts-txt">

    <h3>Details</h3>

	<div class="tribe-events-schedule tribe-clearfix">
		<?php echo tribe_events_event_schedule_details( $event_id, '<strong>', '</strong>' ); ?>
	...
	<p class="tribe-events-back">
		<a href="<?php echo esc_url( tribe_get_events_link() ); ?>">&lsaquo; Back to calendar</a>
	</p>
</div>
<div class="ts-form">
    <h3>Apply Here</h3>
    <script type="text/javascript" src="https://form.jotform.com/jsform/230297979887179"></script>
</div>
</div>
